<?php
require_once 'Apis\Aep_rule_engine.php';
...
class Aep_rule_engine_Demo
{
    public static function Demo(){
        ...
        $result = Aep_rule_engine::saasQueryRule("dFI1lzE0EN2", "xQcjrfNLvQ", "10015488");
        echo("result = " . $result. "\n");
        ...
        $result = Aep_rule_engine::GetRules("dFI1lzE0EN2", "xQcjrfNLvQ", "");
        echo("result = " . $result. "\n");
