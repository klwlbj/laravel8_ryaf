                    ...
                    child:[
                        {
                            id:4,
                            label:'厂家管理',
                            url:'http://test.crzfxjzn.com/admin/materialManufacturer/view',
                        },
                        {
                            id:4,
                            label:'分类管理',
                            url:'http://test.crzfxjzn.com/admin/materialCategory/view',
                        },
                        {
                            id:5,
                            label:'规格管理',
                            url:'http://test.crzfxjzn.com/admin/materialSpecification/view',
                        },
                        {
                            id:6,
                            label:'物品管理',
                            url:'http://test.crzfxjzn.com/admin/material/view',
                        },
                        {
                            id:6,
                            label:'库存流水',
                            url:'http://test.crzfxjzn.com/admin/materialFlow/view',
                        },
                    ]
                }
            ]
