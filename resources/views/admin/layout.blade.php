...
<div style=" display: flex;flex-direction: column;height: 100vh; ">
    <div class="header">
        <div style="height: 50px;background-color: #134974;color: white;display: flex;align-items:center;justify-content:space-between;padding: 0 5px;">
            ...
            <span style="font-size: 16px;font-weight: bold"><span>石井街道办事处，您好。</span>     <a style="margin-left:20px;color: white;text-underline: none" href="https://pingansuiyue.crzfxjzn.com/node/big_screen_new.php">数据大屏</a> <a style="color: white;text-underline: none" href="https://pingansuiyue.crzfxjzn.com/node/logout.php">退出</a></span>
        </div>
    </div>
